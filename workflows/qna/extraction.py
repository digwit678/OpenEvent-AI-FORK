...
SYSTEM_PROMPT = (
    ...
    "- For questions about ACCESSIBILITY (wheelchair access, step-free entry, elevator, disabled access, "
    "accessible bathrooms), use qna_subtype='room_feature_truth'.\n"
    "- For questions about RATE INCLUSIONS (what's included in the price, what comes with the room, "
    "WiFi included, AV included), use qna_subtype='room_feature_truth'.\n"
    "- For general room feature questions (equipment, amenities, capacity), use qna_subtype='room_feature_truth'.\n"
    "- For pricing questions (how much, cost, rates), use qna_subtype='pricing_inquiry'.\n"
    "\n"
