...
11. **After writing or modifying code files, always run the code-simplifier agent to optimize and format the code before considering the task complete.**
12. **Use the doc-agent to update or create any MD files (docs) needed based on your changes.**
## Common Pitfalls
