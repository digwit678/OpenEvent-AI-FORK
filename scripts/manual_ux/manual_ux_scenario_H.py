#!/usr/bin/env python3
"""
Manual UX Scenario H — Site visit followed by participant increase.

Simulates an accepted offer followed by a site visit request and a late
structural change that increases participant count, forcing a return from Step 7
to Step 3 for a larger room before final confirmation.
"""
...
def _message(body: str, msg_id: str) -> Dict[str, Any]:
    return {
        "msg_id": msg_id,
        "from_name": "Scenario H Client",
        "from_email": "clientH@example.com",
        "subject": "Manual UX Scenario H",
        "ts": "2025-04-20T09:00:00Z",
        "body": body,
    }
...
def _schedule_site_visit() -> None:
    ...
    if not visit_state.get("proposed_slots"):
        visit_state["proposed_slots"] = ["16.07.2025 at 10:00", "17.07.2025 at 11:00"]
...
def _script(mapping: Dict[str, Dict[str, Any]]) -> list[Dict[str, Any]]:
    turns: list[Dict[str, Any]] = [
        ...
        {
            "msg_id": "TURN1",
            "body": "Hello! Planning a strategy day for 48 people on 18 July — Room A would be ideal.",
            "info": {"date": "2025-07-18", "participants": 48, "room": "Room A"},
        },
        {
            "msg_id": "TURN2",
            "body": "Thanks for gathering the availability details.",
        },
        {
            "msg_id": "TURN3_HIL",
        ...
        {
            "msg_id": "TURN4",
            "body": "Appreciate the proposal overview.",
        },
        {
            "msg_id": "TURN5",
            "body": "We accept the offer for now.",
        },
        {
            "msg_id": "TURN6",
            "body": "Could we arrange a site visit next week?",
        },
        {
            "msg_id": "TURN6_HIL",
            "body": "HIL approval to send site visit options.",
            "info": {"hil_approve_step": 7},
            "post": _schedule_site_visit,
        },
        {
            "msg_id": "TURN7",
            "body": "We booked the Tuesday slot and our team grew to 60 attendees.",
            "info": {"participants": 60},
        },
        {
            "msg_id": "TURN8",
            "body": "Let’s switch to Room C to fit everyone comfortably.",
            "info": {"room": "Room C"},
        },
        {
            "msg_id": "TURN8_HIL",
            "body": "HIL approval for the updated room availability.",
            "info": {"hil_approve_step": 3},
        },
        {
            "msg_id": "TURN9",
            "body": "Thanks for preparing the refreshed offer draft.",
        },
        {
            "msg_id": "TURN9_HIL",
        ...
        {
            "msg_id": "TURN10",
            "body": "We’re happy with the Room C setup and confirm.",
        },
        {
            "msg_id": "TURN11",
            "body": "Please confirm the Room C booking when ready.",
        },
        {
            "msg_id": "TURN12_HIL",
