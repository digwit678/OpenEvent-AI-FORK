...
pytest -q \
  ...
  tests/specs/products_offer/test_table_ranking_by_menu_prefs.py \
  ...
  tests/specs/ux/test_timeline_export.py \
  tests/specs/determinism/test_timeline_disabled_by_default.py \
