...
class TaskType(str, Enum):
    ...
    # Step 6/7 HIL task types (generalized workflow routing)
    TRANSITION_MESSAGE = "transition_message"  # Step 6: transition blocked/clarification
    CONFIRMATION_MESSAGE = "confirmation_message"  # Step 7: final confirmation/deposit
