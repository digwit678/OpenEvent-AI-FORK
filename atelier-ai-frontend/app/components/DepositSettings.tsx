...
/**
 * DepositSettings Component
 *
 * This component allows managers to configure global deposit settings.
 * The settings are applied to all rooms/offers by default.
 *
 * INTEGRATION NOTE FOR FRONTEND INTEGRATORS:
 * ==========================================
 * This component is designed to integrate with the main OpenEvent frontend.
 * The data format matches the real frontend's deposit structure:
 ...
 *
 * For room-specific deposits (future feature), see:
 * - RoomDepositSettings component (inactive, located in this same directory)
 * - Backend endpoint: POST /api/config/room-deposit/{room_id}
 */
...
export default function DepositSettings({
  ...
  // Calculate VAT (approximate 8.1% Swiss VAT)
  ...
  if (compact && !isEditing) {
    // Compact view - just show status and edit button
    return (
    ...
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
      <div className="p-4 border-b border-gray-200">
        ...
        <p className="text-xs text-gray-500 mt-1">
          Default deposit applied to all offers. Can be overridden per room in the integrated frontend.
        </p>
      </div>
