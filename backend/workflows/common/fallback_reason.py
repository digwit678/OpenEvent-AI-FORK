...
Migration guide:
    # Old import:
    from backend.workflows.common.fallback_reason import FallbackReason, create_fallback_reason

    # New import:
    from backend.core.fallback import FallbackContext, create_fallback_context
"""
