...
- “Tests NOT Yet Verified” checklist (Q&A coverage, shortcuts, and edge cases) — `docs/internal/planning/TODO_NEXT_SESSION.md` (“Tests NOT Yet Verified”).
...
- Open decisions around deposits and production payment verification — `docs/internal/planning/OPEN_DECISIONS.md` (DECISION-001 and DECISION-003).
...
- Junior-dev follow-up checklist for test pages/links/Q&A shortcut behavior — `docs/internal/planning/JUNIOR_DEV_FOLLOW_UP.md` (“Testing Checklist”).
